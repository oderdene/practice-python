...
test_min_max()
test_traverse()
test_delete_lone_root_node()
test_delete_lone_node_left_from_parent_root()
test_delete_lone_node_right_from_parent_root()
test_delete_lone_node_left_from_parent()
test_delete_lone_node_right_from_parent()
test_delete_root_node_only_left_child()
test_delete_only_left_child_left_from_parent()
test_delete_only_left_child_right_from_parent()
test_delete_root_node_lone_leftmost_rightsubtree_child()
test_delete_lone_leftmost_rightsubtree_child()
test_delete_root_node_leftmost_rightsubtree_child_with_right_child()
test_delete_root_node_only_left_child()
test_delete_root_node_only_right_child()
test_delete_lone_leftmost_rightsubtree_child_with_right_child